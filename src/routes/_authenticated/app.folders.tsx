...
export function FoldersPage() {
  ...
  const accessRows = [{ id: "unfiled", name: "Без папки", folder: "" }, ...rows.map((row) => ({ id: row.id, name: row.name, folder: row.name }))];
