...
import { ColumnSettings, InlineText, MetadataManager, NotesCell, ResizableHead, StatusCell, statusTone, useColumnWidths, type FixedColumn } from "@/components/profile-table-tools";
